...
source venv4/bin/activate # Change venv6 to your python virtual environment (which should be in the working directory)

module load cuda/9.0

python3 train_microarray_domains.py config/microarray_rna.yaml # Select the .yaml file here
